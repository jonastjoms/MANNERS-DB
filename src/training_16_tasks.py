...
pickle.dump(data, open( "data/data_16_task.p", "wb" ))
...
for parameter_search in range(20):
    ...
    task_order = np.random.randint(len(task_outputs), size=len(task_outputs))
    print()
    print('-'*100)
    ...
    args.approach = args.approach + '_epochs_:' + str(args.n_epochs) + '_lr_:' + str(args.lr) + '_hidden_:' + str(args.hidden_size) + '_task_order_:' + str(task_order) 
